package com.iyoyogo.android.ui.home.video;
...
public class VideoTrimmerView extends FrameLayout {
    ...
    private static final int  SCREEN_WIDTH_FULL     = UiUtils.getScreenPix().widthPixels;
    public static final  int  RECYCLER_VIEW_PADDING = UiUtils.dip2px(35);
    ...
    private static final int  THUMB_HEIGHT          = UiUtils.dip2px(50);
    ...
    private void initRangeSeekBarView() {
        ...
        if (mDuration <= MAX_SHOOT_DURATION) {
            ...
            rangeWidth = mMaxWidth / MAX_COUNT_RANGE * mThumbsTotalCount;
...
//        mVideoShootTipTv.setText(String.format("拖动选择你要发表的%d秒以内片段！", VIDEO_MAX_TIME));
    }

    private void startShootVideoThumbs(final Context context, final Uri videoUri, int totalThumbsCount, long startPosition, long endPosition) {

        shootVideoThumbInBackground(context, videoUri, totalThumbsCount, startPosition, endPosition).subscribe(new Observer<Bitmap>() {
            @Override
    ...
    public static Observable<Bitmap> shootVideoThumbInBackground(final Context context, final Uri videoUri, final int totalThumbsCount, final long startPosition, final long endPosition) {
    ...
    private void setUpListeners() {
        ...
        findViewById(R.id.iv_done).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                onSaveClicked();
            }
...
//            trim(mContext, mSourceUri.getPath(), getTrimmedVideoPath(), mLeftProgressPos, mRightProgressPos, mOnTrimVideoListener);
        VideoUtil.cutVideo(mSourceUri.getPath(), VideoUtil.getTrimmedVideoPath(mContext, "video/trimmedVideo", "trimmedVideo_"), mLeftProgressPos / 1000, mRightProgressPos / 1000).subscribe(new Observer<String>() {
            @Override
            public void onSubscribe(Disposable d) {
            ...
            public void onNext(String s) {
                mOnTrimVideoListener.onFinishTrim(s);
            }
