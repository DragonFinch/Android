...
public class VideoTrimmerAdapter extends RecyclerView.Adapter {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    return new TrimmerViewHolder(mInflater.inflate(R.layout.item_video_frame, parent, false));
  }
  ...
  private final class TrimmerViewHolder extends RecyclerView.ViewHolder {
    ...
    TrimmerViewHolder(View itemView) {
      ...
      layoutParams.width = VideoTrimmerView.VIDEO_FRAMES_WIDTH / VideoTrimmerView.MAX_COUNT_RANGE;
