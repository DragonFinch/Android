 ...
 * 表情转换工具
 */
public class MyConversionUtil {

    /** 每一页表情的个数 */
    private int pageSize = 20;

    private static MyConversionUtil mFaceConversionUtil;
    ...
    private MyConversionUtil() {

    }

    public static MyConversionUtil getInstace() {
        if (mFaceConversionUtil == null) {
            mFaceConversionUtil = new MyConversionUtil();
        }
