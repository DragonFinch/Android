package com.iyoyogo.android.utils.icondottextview;
...
public class TextConfig implements Config {
    ...
    public TextConfig(TypedArray typedArray) {
        ...
        if (typedArray != null) {
            mSize = typedArray.getDimensionPixelSize(R.styleable.IconDotTextView_text_sizes, DEFAULT_SIZE);
            mColorStateList = typedArray.getColorStateList(R.styleable.IconDotTextView_textColors);
            if (mColorStateList == null) {
                mColorStateList = ColorStateList.valueOf(DEFAULT_COLOR);
            }
            mText = typedArray.getString(R.styleable.IconDotTextView_textes);
        }
        init();
    }
