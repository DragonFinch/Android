...
public class AppUtils {
    ...
    public static void downloadApkByDownloadManager(Context context) {
        ...
        //DownloadManager实现下载
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(Constants.NEW_VERSION_APP_URL));
        request.setTitle("文件下载")
                .setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS,Constants.NEW_VERSION_APK_NAME)
                //设置通知在下载中和下载完成都会显示
    ...
    public static void installApk(Context context) {
        ...
        intent.setDataAndType(
                Uri.fromFile(new File(Environment.getExternalStoragePublicDirectory(
                        Environment.DIRECTORY_DOWNLOADS), Constants.NEW_VERSION_APK_NAME)),
