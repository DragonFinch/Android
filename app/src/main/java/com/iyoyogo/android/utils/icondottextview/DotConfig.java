...
public class DotConfig implements Config {
    ...
    public DotConfig(TypedArray typedArray) {
        ...
        if (typedArray != null) {
            ...
            int textSize = typedArray.getDimensionPixelSize(R.styleable.IconDotTextView_dot_textSizes, DEFAULT_TEXT_SIZE);
            int textColor = typedArray.getColor(R.styleable.IconDotTextView_dot_textColors, DEFAULT_TEXT_COLOR);
