package com.iyoyogo.android.utils.util.badgeview;
...
public class BadgeViewPro extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        bgColor = ta.getColor(R.styleable.BadgeViewPro_bgColors, Color.RED);
        textColor = ta.getColor(R.styleable.BadgeViewPro_textColors, Color.WHITE);
        ...
        if (!(getLayoutParams() instanceof LinearLayout.LayoutParams)) {
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, gravity);
    ...
    public void setTargetView(final View target) {
        ...
        target.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
           ...
           if (target.getParent() instanceof RelativeLayout) {
                 RelativeLayout parentContainer = (RelativeLayout) target.getParent();
     ...
     */
    private void setParams(View target, RelativeLayout parentContainer) {
