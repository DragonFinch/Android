...
public class MinePraisePresenter extends BasePresenter<MinePraiseContract.View> implements MinePraiseContract.Presenter {
    public MinePraisePresenter(MinePraiseContract.View mView) {
        super(mView);
    }

    @Override
    public void getPraise(String user_id, String user_token, int page, int page_size) {
        DataManager.getFromRemote()
        .getPraise(user_id,user_token,page,page_size)
