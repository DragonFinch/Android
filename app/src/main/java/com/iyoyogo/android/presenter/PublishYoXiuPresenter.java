...
public class PublishYoXiuPresenter extends BasePresenter<PublishYoXiuContract.View> implements PublishYoXiuContract.Presenter {
    ...
    @Override
    public void publishYoXiu(String user_id, String user_token, String file_path, int file_type, String file_desc, int[] channel_ids, Integer[] topic_ids, int open, int valid, String position_name, String position_areas, String position_address, String filter_id) {
        DataManager.getFromRemote().publish_yoXiu(user_id, user_token, file_path, file_type, file_desc, channel_ids, topic_ids, open, valid, position_name, position_areas, position_address, filter_id)
