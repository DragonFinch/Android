 ...
 */
package com.iyoyogo.android.camera.selectmedia.adapter;
...
import com.iyoyogo.android.camera.selectmedia.interfaces.OnItemClick;
import com.iyoyogo.android.camera.selectmedia.utils.TimeUtil;
...
public class AgendaItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public void render(MediaData mediaData, final int se, final int position, final OnItemClick onItemClick) {
        //设置当前的图片为正方形
        int width = ScreenUtils.getWindowWidth(App.getmContext());
