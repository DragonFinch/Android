...
import com.iyoyogo.android.widget.PhotoDrawRect;
...
public class PhotoMovementActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initDrawRect(){
        ...
        mAreaStartDrawROI.setDrawRect("开始画面",Constants.EDIT_MODE_PHOTO_AREA_DISPLAY);
        ...
        mAreaEndDrawROI.setDrawRect("结束画面",Constants.EDIT_MODE_PHOTO_AREA_DISPLAY);
