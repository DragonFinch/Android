package com.iyoyogo.android.camera.edit.clipEdit.spilt;
...
public class SpiltActivity extends BaseActivity implements View.OnClickListener {
        ...
        switch (id) {
            ...
            case R.id.spiltFinish:
                if(mSpiltPoint < Constants.NS_TIME_BASE){
                    Util.showDialog(SpiltActivity.this, "提示", "不可分割小于1秒的素材");
                    return;
                }
