package com.iyoyogo.android.camera;
...
public class VideoFragment extends Fragment {
    ...
    public void firstSetWaterMarkPosition(int w, int h) {
        setPointFListLiveWindow(w, h);
        Point point = mDrawRect.getPicturePoint();
        ...
        int x1 = w;
        List<PointF> newList = setFourPointToList(x0, x1, 0, defaultHeight);
