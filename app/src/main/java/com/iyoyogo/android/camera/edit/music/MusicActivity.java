package com.iyoyogo.android.camera.edit.music;
...
import com.iyoyogo.android.camera.record.SqView;
...
public class MusicActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Button m_multiOkBtn, m_playBtn, m_addMusicBtn, m_delMusicBtn, m_fadeBtn;
    ...
    protected void initView() {
        ...
        m_multiOkBtn = (Button) findViewById(R.id.ok_btn);
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        m_musicSingleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(intent, Constants.ACTIVITY_START_CODE_MUSIC_SINGLE);
            }
        });
        ...
        m_addMusicBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MusicActivity.this, SelectMusicActivity.class);
                startActivityForResult(intent, Constants.ACTIVITY_START_CODE_MUSIC_MULTI);
            }
        });
