...
import com.iyoyogo.android.camera.edit.watermark.SingleClickActivity;
...
import com.iyoyogo.android.widget.CustomViewPager;
import com.iyoyogo.android.widget.NvsTimelineEditor;
import com.iyoyogo.android.widget.NvsTimelineTimeSpan;
...
public class AnimateStickerActivity extends BaseActivity implements View.OnClickListener {
    ...
    //新添加贴纸对象
    NvsTimelineAnimatedSticker mAddAnimateSticker = null;
    ...
    private void applyAnimateSticker(int pos){
        ...
        if(mAddAnimateSticker != null){
            ...
            if(timeSpan != null) {
                AnimateStickerTimeSpanInfo timeSpanInfo = new AnimateStickerTimeSpanInfo(mAddAnimateSticker, timeSpan);
    ...
    private void addAllTimeSpan(){
        ...
        while (animatedSticker != null){
            ...
            if(timeSpan != null) {
                AnimateStickerTimeSpanInfo timeSpanInfo = new AnimateStickerTimeSpanInfo(animatedSticker, timeSpan);
                mTimeSpanInfoList.add(timeSpanInfo);
            }
            animatedSticker = mTimeline.getNextAnimatedSticker(animatedSticker);
        }
