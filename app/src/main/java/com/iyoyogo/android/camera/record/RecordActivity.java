...
import com.iyoyogo.android.widget.VerticalSeekBar;
...
public class RecordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout m_recordFxLayout;
    ...
    protected void initView() {
        ...
        m_recordFxLayout = (LinearLayout) findViewById(R.id.record_fx_layout);
        m_fxOkBtn = (Button) findViewById(R.id.fx_ok_btn);
        m_recordFxRv = (RecyclerView) findViewById(R.id.record_fx_rv);
        m_okBtn = (Button) findViewById(R.id.filter_list);
    ...
    public void initTitle() {
        m_titleBar.setTextCenter(R.string.record);
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        // 静音权限
        m_notificationManager = (NotificationManager) App.getmContext().getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    private void getRecordFxList() {
        if (m_recordFxAdapter == null) {
            ...
            GridLayoutManager linearLayoutManager = new GridLayoutManager(this, 5, LinearLayoutManager.VERTICAL, false);
    ...
    private void initVideoFragment() {
        ...
        getSupportFragmentManager().beginTransaction()
                ...
                .commit();
        getSupportFragmentManager().beginTransaction().show(m_videoFragment);
    }
