...
public class ImageConverter {
    ...
    public static Bitmap convertImage(String srcImageFilePath) {
        ...
        // Decode image file
        Bitmap bitmap = BitmapFactory.decodeFile(srcImageFilePath, opt);
        if (bitmap == null) {
            return null;
        }
        int rotation = 0;
    ...
    public static boolean convertImage(String srcImageFilePath, String dstImageFilePath) {
        Bitmap targetBitmap = convertImage(srcImageFilePath);
    ...
    public static Point getPicturePoint(String filePath) {
        if (filePath != null) {
            BitmapFactory.Options opt = new BitmapFactory.Options();
            opt.inJustDecodeBounds = true;
            // Determine source image size
