package com.iyoyogo.android.camera.edit.grallyRecyclerView;
...
import com.iyoyogo.android.camera.base.BaseConstants;
...
public class GrallyScaleHelper {
    ...
    public void onBindViewHolder(View itemView, final int position, int itemCount, ImageView imageView) {
        float mPagePadding = (ScreenUtils.getScreenWidth(App.getmContext()) - ScreenUtils.dip2px(App
                .getmContext(), 212)) / 2;
