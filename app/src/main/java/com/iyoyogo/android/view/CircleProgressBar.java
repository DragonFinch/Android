...
public class CircleProgressBar extends View {
    ...
    public static final int STATE_PRESS = 1;       //按下状态
    public static final int STATE_LONG_PRESS = 2;  //长按状态
    public static final int STATE_RECORDERING = 3; //录制状态
    public static final int STATE_BAN = 4;         //禁止状态
    ...
    private int duration=10*1000;           //录制视频最大时间长度
    private int min_duration=1*1000;       //最短录制时间限制
    private int recorded_time;      //记录当前录制的时间

    private static final float DEFAULT_LINE_WIDTH = 4.0f;
    //TODO
    // 字体大小
    private static final float DEFAULT_PROGRESS_TEXT_SIZE = 0.0f;
...
//    private LongPressRunnable longPressRunnable=new LongPressRunnable();;    //长按后处理的逻辑Runnable
...
//        setButtonFeatures(button_state);
//        setDuration(10*1000);
    }
