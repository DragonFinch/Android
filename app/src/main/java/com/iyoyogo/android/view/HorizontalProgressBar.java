...
public class HorizontalProgressBar extends View {
     ...
     * 进度条背景颜色
     */
    private int bgColor       = Color.parseColor("#4cf1f1f1");
    /**
     * 进度条颜色
     */
    private int progressColor = Color.parseColor("#FFEDB6");
    ...
    private void initPaint() {
        ...
        linePaint = getPaint(dp2px(1), progressColor, Paint.Style.FILL);
        initTextPaint();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float stopX = currentProgress;
        stopX = stopX < getPaddingLeft() ? getPaddingLeft() : stopX;
        canvas.drawLine(getPaddingLeft(),
                tipHeight + progressMarginTop,
                stopX,
                tipHeight + progressMarginTop,
        ...
        canvas.drawLine(stopX,
                tipHeight,
                stopX,
                tipHeight + dp2px(16), linePaint);
        drawTipView(canvas);
    ...
    private void drawText(Canvas canvas, String textString) {
        ...
        //文字绘制到整个布局的中心位置
        canvas.drawText(showStr, textRect.centerX(), baseline, textPaint);
    }
    ...
    private void initAnimation() {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                currentProgress = value * mWidth / mMax;
                //进度回调方法
