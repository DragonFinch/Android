...
public interface PublishYoJiContract {
    ...
    interface Presenter extends IBasePresenter{
        ...
        void publishYoJi(String user_id, String user_token, int yo_id, String logo, String title, String desc, int cost, int open, int valid, List<Integer> topic_ids, List<Integer> channel_ids, List<MessageBean> list);
    }
}
