 ...
 * 获取 用户 关注的人群
 */
public class AttentionsAdapter extends BaseQuickAdapter<AttentionsBean.DataBean.ListBean, BaseViewHolder> {


    public AttentionsAdapter(int layoutResId, @Nullable List<AttentionsBean.DataBean.ListBean> data) {
