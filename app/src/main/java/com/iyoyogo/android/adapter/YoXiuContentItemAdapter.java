 ...
 * yo秀列表评论的适配器
 */
public class YoXiuContentItemAdapter extends RecyclerView.Adapter<YoXiuContentItemAdapter.ViewHolder> implements View.OnClickListener {
    private Context context;
    List<YoXiuContentBean.DataBean.ListBean.CommentListBean> mList;
    private OnClickListener onClickListener;

    public YoXiuContentItemAdapter(Context context, List<YoXiuContentBean.DataBean.ListBean.CommentListBean> comment_list) {
