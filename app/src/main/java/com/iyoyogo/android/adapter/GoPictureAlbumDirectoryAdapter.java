...
public class GoPictureAlbumDirectoryAdapter extends RecyclerView.Adapter<GoPictureAlbumDirectoryAdapter.ViewHolder> {
    private Context                mContext;
    private List<LocalMediaFolder> folders = new ArrayList<>();
    private int                    mimeType;

    public GoPictureAlbumDirectoryAdapter(Context mContext) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.item_album_folder_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (mimeType == PictureMimeType.ofAudio()) {
            holder.first_image.setImageResource(com.luck.picture.lib.R.drawable.audio_placeholder);
        } else {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            first_image = (ImageView) itemView.findViewById(com.luck.picture.lib.R.id.first_image);
            tv_folder_name = (TextView) itemView.findViewById(com.luck.picture.lib.R.id.tv_folder_name);
            image_num = (TextView) itemView.findViewById(com.luck.picture.lib.R.id.image_num);
            tv_sign = (TextView) itemView.findViewById(com.luck.picture.lib.R.id.tv_sign);
        }
    }
